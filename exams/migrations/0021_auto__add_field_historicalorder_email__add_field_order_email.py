...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HistoricalOrder.email'
        db.add_column(u'exams_historicalorder', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='nobody@nowhere.invalid', max_length=75),
                      keep_default=False)

        # Adding field 'Order.email'
        db.add_column(u'exams_order', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='nobody@nowhere.invalid', max_length=75),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HistoricalOrder.email'
        db.delete_column(u'exams_historicalorder', 'email')

        # Deleting field 'Order.email'
        db.delete_column(u'exams_order', 'email')
