...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HistoricalCandidateUpload.status'
        db.add_column(u'exams_historicalcandidateupload', 'status',
                      self.gf('django.db.models.fields.CharField')(default='U', max_length=1),
                      keep_default=False)

        # Adding field 'CandidateUpload.status'
        db.add_column(u'exams_candidateupload', 'status',
                      self.gf('django.db.models.fields.CharField')(default='U', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HistoricalCandidateUpload.status'
        db.delete_column(u'exams_historicalcandidateupload', 'status')

        # Deleting field 'CandidateUpload.status'
        db.delete_column(u'exams_candidateupload', 'status')
