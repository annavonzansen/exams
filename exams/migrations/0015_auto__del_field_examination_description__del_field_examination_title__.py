...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Examination.description'
        db.delete_column(u'exams_examination', 'description')

        # Deleting field 'Examination.title'
        db.delete_column(u'exams_examination', 'title')


        # Changing field 'Examination.slug'
        db.alter_column(u'exams_examination', 'slug', self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, max_length=50, separator=u'-', populate_from=['year', 'season'], overwrite=False))
    ...
    def backwards(self, orm):
        # Adding field 'Examination.description'
        db.add_column(u'exams_examination', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Examination.title'
        db.add_column(u'exams_examination', 'title',
                      self.gf('django.db.models.fields.CharField')(unique=True, max_length=255, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Examination.slug'
        db.alter_column(u'exams_examination', 'slug', self.gf('django_extensions.db.fields.AutoSlugField')(populate_from=['title'], allow_duplicates=False, max_length=50, separator=u'-', overwrite=False))
