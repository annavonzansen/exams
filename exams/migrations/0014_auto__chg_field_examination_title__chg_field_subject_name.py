...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Examination.title'
        db.alter_column(u'exams_examination', 'title', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True))

        # Changing field 'Subject.name'
        db.alter_column(u'exams_subject', 'name', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=255))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Examination.title'
        raise RuntimeError("Cannot reverse this migration. 'Examination.title' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Examination.title'
        db.alter_column(u'exams_examination', 'title', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True))

        # Changing field 'Subject.name'
        db.alter_column(u'exams_subject', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255, null=True))
