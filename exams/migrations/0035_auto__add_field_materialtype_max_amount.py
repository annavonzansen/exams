...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MaterialType.max_amount'
        db.add_column(u'exams_materialtype', 'max_amount',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MaterialType.max_amount'
        db.delete_column(u'exams_materialtype', 'max_amount')
