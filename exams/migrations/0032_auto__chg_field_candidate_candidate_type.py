...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Candidate.candidate_type'
        db.alter_column(u'exams_candidate', 'candidate_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exams.CandidateType'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Candidate.candidate_type'
        raise RuntimeError("Cannot reverse this migration. 'Candidate.candidate_type' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Candidate.candidate_type'
        db.alter_column(u'exams_candidate', 'candidate_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exams.CandidateType']))
