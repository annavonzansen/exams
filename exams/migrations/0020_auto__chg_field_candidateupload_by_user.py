...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CandidateUpload.by_user'
        db.alter_column(u'exams_candidateupload', 'by_user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'CandidateUpload.by_user'
        db.alter_column(u'exams_candidateupload', 'by_user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
    ...
    models = {
        ...
        u'exams.candidateupload': {
            ...
            'by_user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'examination': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['exams.Examination']", 'blank': 'True'}),
            'file': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'school': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['education.School']", 'blank': 'True'}),
