...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'exams_subjectgroup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal(u'exams', ['SubjectGroup'])

        # Adding field 'HistoricalSubject.group_id'
        db.add_column(u'exams_historicalsubject', u'group_id',
        ...
        # Adding field 'Subject.group'
        db.add_column(u'exams_subject', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['exams.SubjectGroup']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'SubjectGroup'
        db.delete_table(u'exams_subjectgroup')

        # Deleting field 'HistoricalSubject.group_id'
        db.delete_column(u'exams_historicalsubject', u'group_id')
        ...
        # Deleting field 'Subject.group'
        db.delete_column(u'exams_subject', 'group_id')
