...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'exams_materialtype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('short', self.gf('django.db.models.fields.CharField')(unique=True, max_length=2)),
        ))
        db.send_create_signal(u'exams', ['MaterialType'])

        # Adding field 'OrderItem.material_type'
        db.add_column(u'exams_orderitem', 'material_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['exams.MaterialType']),
                      keep_default=False)
        ...
        # Adding field 'HistoricalOrderItem.material_type_id'
        db.add_column(u'exams_historicalorderitem', u'material_type_id',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'exams_materialtype')

        # Deleting field 'OrderItem.material_type'
        db.delete_column(u'exams_orderitem', 'material_type_id')

        # Deleting field 'OrderItem.special_arrangement'
        db.delete_column(u'exams_orderitem', 'special_arrangement_id')

        # Deleting field 'HistoricalOrderItem.material_type_id'
        db.delete_column(u'exams_historicalorderitem', u'material_type_id')
