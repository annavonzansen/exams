...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Examination.registration_begin'
        db.add_column(u'exams_examination', 'registration_begin',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Examination.registration_end'
        db.add_column(u'exams_examination', 'registration_end',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Examination.registration_status'
        db.add_column(u'exams_examination', 'registration_status',
                      self.gf('django.db.models.fields.CharField')(default='D', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Examination.registration_begin'
        db.delete_column(u'exams_examination', 'registration_begin')

        # Deleting field 'Examination.registration_end'
        db.delete_column(u'exams_examination', 'registration_end')

        # Deleting field 'Examination.registration_status'
        db.delete_column(u'exams_examination', 'registration_status')
