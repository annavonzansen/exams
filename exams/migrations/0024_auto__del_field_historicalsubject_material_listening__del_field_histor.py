...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HistoricalSubject.material_listening'
        db.delete_column(u'exams_historicalsubject', 'material_listening')

        # Deleting field 'HistoricalSubject.material_writing'
        db.delete_column(u'exams_historicalsubject', 'material_writing')
    ...
    def backwards(self, orm):
        # Adding field 'HistoricalSubject.material_listening'
        db.add_column(u'exams_historicalsubject', 'material_listening',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'HistoricalSubject.material_writing'
        db.add_column(u'exams_historicalsubject', 'material_writing',
