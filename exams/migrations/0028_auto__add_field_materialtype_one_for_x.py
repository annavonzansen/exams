...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MaterialType.one_for_x'
        db.add_column(u'exams_materialtype', 'one_for_x',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MaterialType.one_for_x'
        db.delete_column(u'exams_materialtype', 'one_for_x')
