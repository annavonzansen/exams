...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'exams_assignment', 'test',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['exams.Test']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Assignment.test'
        db.delete_column(u'exams_assignment', 'test_id')
