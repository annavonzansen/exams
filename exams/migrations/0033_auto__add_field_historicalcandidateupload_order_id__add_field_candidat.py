...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HistoricalCandidateUpload.order_id'
        db.add_column(u'exams_historicalcandidateupload', u'order_id',
                      self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CandidateUpload.order'
        db.add_column(u'exams_candidateupload', 'order',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exams.Order'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HistoricalCandidateUpload.order_id'
        db.delete_column(u'exams_historicalcandidateupload', u'order_id')

        # Deleting field 'CandidateUpload.order'
        db.delete_column(u'exams_candidateupload', 'order_id')
