...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field material_types on 'Subject'
        m2m_table_name = db.shorten_name(u'exams_subject_material_types')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('subject', models.ForeignKey(orm[u'exams.subject'], null=False)),
            ('materialtype', models.ForeignKey(orm[u'exams.materialtype'], null=False))
        ))
        db.create_unique(m2m_table_name, ['subject_id', 'materialtype_id'])


    def backwards(self, orm):
        # Removing M2M table for field material_types on 'Subject'
        db.delete_table(db.shorten_name(u'exams_subject_material_types'))
