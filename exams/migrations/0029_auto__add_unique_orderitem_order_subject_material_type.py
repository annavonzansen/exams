...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'OrderItem', fields ['order', 'subject', 'material_type']
        db.create_unique(u'exams_orderitem', ['order_id', 'subject_id', 'material_type_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'OrderItem', fields ['order', 'subject', 'material_type']
        db.delete_unique(u'exams_orderitem', ['order_id', 'subject_id', 'material_type_id'])
    ...
    models = {
        ...
        u'exams.orderitem': {
            'Meta': {'unique_together': "(('order', 'subject', 'material_type'),)", 'object_name': 'OrderItem'},
            'amount': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
