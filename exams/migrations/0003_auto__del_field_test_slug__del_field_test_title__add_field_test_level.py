...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Test.slug'
        db.delete_column(u'exams_test', 'slug')

        # Deleting field 'Test.title'
        db.delete_column(u'exams_test', 'title')
    ...
    def backwards(self, orm):
        # Adding field 'Test.slug'
        db.add_column(u'exams_test', 'slug',
        ...
        # User chose to not deal with backwards NULL issues for 'Test.title'
        raise RuntimeError("Cannot reverse this migration. 'Test.title' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Test.title'
        db.add_column(u'exams_test', 'title',
