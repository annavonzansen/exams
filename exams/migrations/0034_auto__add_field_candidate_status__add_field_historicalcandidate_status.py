...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Candidate.status'
        db.add_column(u'exams_candidate', 'status',
                      self.gf('django.db.models.fields.CharField')(default='c', max_length=1),
                      keep_default=False)

        # Adding field 'HistoricalCandidate.status'
        db.add_column(u'exams_historicalcandidate', 'status',
                      self.gf('django.db.models.fields.CharField')(default='c', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Candidate.status'
        db.delete_column(u'exams_candidate', 'status')

        # Deleting field 'HistoricalCandidate.status'
        db.delete_column(u'exams_historicalcandidate', 'status')
